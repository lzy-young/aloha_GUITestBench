...
class Executor_UITARS_1_5(MyAgent):
    name = "UI-TARS-1.5"
    
    def __init__(self, task: str, app_name: str, config_path: str = './configs/setup_uitars_1_5.yaml') -> None:
        ...
        super().__init__(
            ...
            llms={
                "worker": LLMConfig(
                    name=worker_config.get('llms', 'uitars_1_5'), 
    ...
    def extract_steps(self) -> list:
        ...
        for step in self.trace:
            data.append({
                ...
                'action': {
                    'raw_action': step.action.raw_action,                           # UI-TARS-1.5 action
