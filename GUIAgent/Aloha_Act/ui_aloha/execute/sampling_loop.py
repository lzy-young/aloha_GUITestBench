...
from GUIAgent.Aloha_Act.ui_aloha.execute.utils.server_connection import is_image_path, send_inference_request
from GUIAgent.Aloha_Act.ui_aloha.execute.gui_parser.gui_capture import capture_screenshot
